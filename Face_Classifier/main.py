...
# GLOBAL VARIABLES
train_dir = '/home/salim/Coding/DeepLearning/DATA/train_images'
test_dir = '/home/salim/Coding/DeepLearning/DATA/test_images'
...
if __name__ == '__main__':
    ...
    train_data, test_data, train_loader, valid_loader, test_loader = load_datasets(train_dir,test_dir,batch_size,valid_size,transform)
    ...
    net.to(device)
    # Train the network
    #net = train_net(train_loader,net, device,optimizer,criterion,model_path)
    # OR load saved model
    net = Net()
